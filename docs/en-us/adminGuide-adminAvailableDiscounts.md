...
**Add a Discount**
: Creates a new discount. See [Adding or updating discounts](docs/en-us/adminGuide-discountsAddingOrUpdatingToastDiscounts).



**Order**
: Sets the sequence in which to auto-apply discounts. See [Automatically applying discounts](docs/en-us/adminGuide-adminAutoApplyDiscounts).
...
From the displayed promo code information, you can edit the Code and Description fields. You cannot edit the promo code's effective dates. See [Requiring promo codes for discounts](docs/en-us/adminGuide-adminDiscountPromoCodes).
...
See [Archiving and restoring discounts](docs/en-us/adminGuide-adminDiscountsArchive).
...
For more information, see [Discount types](docs/en-us/adminGuide-adminDiscountTypes).
...
See [Archiving and restoring discounts](docs/en-us/adminGuide-adminDiscountsArchive) and [Copying discounts](docs/en-us/adminGuide-adminCopyingDiscounts).
