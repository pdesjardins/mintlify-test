---
title: "Third-party online ordering channels"
id: platformThirdPartyOnlineOrderingChannelsOmitChunkFromSearchIndex
type: section
...
previousSectionFile: adminGuide-adminDiningOptionsOnlineOrdering.md
previousSectionTitle: "Dining options for Toast online orders"
...
> **Note**
> 
> To access third-party online ordering configuration settings, you must have the 6.6 Restaurant Operations Setuppermission. For more information about permissions, see [Web setup access permissions](platformEmployeesOmitChunkFromSearchIndex.html#adminWebSetupAccessPermissions).
...
After you make your selection, Toast Web automatically saves and publishes your changes. A `Toast Online Ordering configuration
        published successfully to [restaurant name]` notification appears at the bottom of the screen.
