...
- A lock icon next to the name of the open cash drawer if the drawer is locked to the employee. For more information, see [Cash drawer lockdown](docs/en-us/adminGuide-adminCashDrawerLockdown).
...
- Cash drawer actions. For more information, see [Open cash drawer actions](docs/en-us/adminGuide-adminCashDrawers#adminOpenCashDrawerActions).
...
For more information, see [POS cash drawer operations](docs/en-us/adminGuide-adminCashDrawerPOSOperations).
...
> **Note**
> 
> A Cash Collected entry is created if you undo a previous Tip Out entry. This includes cash collected from a server. For more information on how to undo a cash entry, see [Undoing cash drawer actions](docs/en-us/adminGuide-adminUndoingOperations).
...
On the Cash drawer activity screen, you can view the cash entries for a paused cash drawer and complete cash drawer actions. The Cash drawer activity screen displays the same information and actions as the [Open cash drawer screen](docs/en-us/adminGuide-adminCashDrawers#adminOpenCashDrawersScreen).

### Paused cash drawer actions

The same cash drawer actions available for an open cash drawer are also available for a paused cash drawer. For more information, see [Open cash drawer actions](docs/en-us/adminGuide-adminCashDrawers#adminOpenCashDrawerActions).
...
From a closed drawer, you can create a deposit. For more information, see [Cash deposits](docs/en-us/adminGuide-adminCashDeposits).
