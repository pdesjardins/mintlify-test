...
These settings are available on the details pages for menus, menu groups, menu items, modifier groups, and [modifier item references](adminPricingModifierOptions.html#adminUnderstandingAModifierOptionsItemReference).
...
For more information, see [Restricting menu visibility to specific online ordering partners](platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy.html).
