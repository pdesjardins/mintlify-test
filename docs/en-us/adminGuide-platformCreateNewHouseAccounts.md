...
> **Note**
> 
> The creation of multiple house accounts is permanent and cannot be undone. You can always choose to archive a house account at any time. For more information, see [Archiving a house account](docs/en-us/adminGuide-platformArchiveHouseAccount).
