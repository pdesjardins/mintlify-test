...
(2) The end date of the time range for the labor reporting data, in YYYYMMDDformat.
...
(1) Send a POSTrequest to the /era/v1/labor/{timeRange}endpoint of the analytics API. The {timeRange}in this example is week.
...
(2) The end date of the time range for the labor reporting data, in YYYYMMDDformat. The endBusinessDatevalue is optional for requests using the daytime range.
