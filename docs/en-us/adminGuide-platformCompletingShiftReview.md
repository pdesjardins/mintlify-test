...
3. Select the **Done** button to start your shift. This opens the **Shift Review**screen.
...
3. Select the **View closed checks** button to view closed checks on the **Payment Terminal**screen, or the **Next **button to continue with the next step in shift review.
...
4. Select the **Count Bills** button to open the Toast bill/coin calculator to assist with the cash-counting process, or select the **Cancel **button to cancel out of the dialog box, or select the **Close Drawer**button to close your drawer and the dialog box. This returns you back to the **Shift Review** screen.
