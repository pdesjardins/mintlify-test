...
For more information on versions and how the Toast platform resolves which version to use, see [Session restaurant](docs/en-us/adminGuide-sessionRestaurant).
