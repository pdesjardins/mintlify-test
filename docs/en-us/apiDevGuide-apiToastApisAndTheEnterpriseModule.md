...
Using Toast Web, you define configuration for
  ...
  configuration changes, see [Publishing updates to restaurant configuration](adminGuide-platformPublishingOverview).
...
For more information on versions and how the Toast platform resolves
  which version to use, see [Session restaurant](adminGuide-sessionRestaurant).



> **Note**
> 
> Because they can be shared among locations, employees are managed
    somewhat differently than other configuration entities. Future
    documentation will cover how the Toast APIs behave with respect to
    employees.
