---
title: "Determining if a restaurant's menu data has gone stale"
id: apiDeterminingIfYourMenuJsonIsOutdated_V2
type: section
...
For more information on the `menus` webhook, see [Menus webhook](docs/en-us/apiDevGuide-apiMenusWebhook). For more information on the `/metadata` endpoint, see the [menus API reference documentation](https://doc.toasttab.com/openapi/menus/overview/).
