---
title: "Settings copy feature"
id: platformSettingsCopyOmitChunkFromSearchIndex
type: section
...
previousSectionFile: adminGuide-adminExportingEnterpriseReports.md
previousSectionTitle: "Exporting enterprise reports"
...
Unlike when targets and owners are used, once you copy settings using the settings copy tool, changing those settings does not affect other locations. Settings are copied from the [session restaurant](understandingKeyEnterpriseConceptsOmitChunkFromSearchIndex.html#sessionRestaurant).
