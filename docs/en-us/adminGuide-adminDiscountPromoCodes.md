...
For more information about code values, see [Code value](adminDiscountPromoCodes.html#adminDiscountPromoCodeCode).
...
For more information about single-use promo codes, see [Single use promo codes](adminDiscountPromoCodes.html#adminDiscountPromoCodeSingleUse).
...
For more information about the effective dates for promo codes, see [Promo code effective dates](adminDiscountPromoCodes.html#adminPromoCodeDates).
