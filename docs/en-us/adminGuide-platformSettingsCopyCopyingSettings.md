...
Tags include the number of settings with that tag on that page or in that section.
...
- Search a page category, section, or setting name using the search box.


- Select the checkbox next to a page category to copy all settings in that category.


- Select the expand/collapse icon to the left of the page category to see setting sections and individual settings, and select the checkbox next to a section, setting name, or both.
...
> **Note**
> 
> Next to the page category name is a redirect icon that leads to the page where the settings in that page category are found.
