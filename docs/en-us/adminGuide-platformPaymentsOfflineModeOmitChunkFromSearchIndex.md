...
id: platformPaymentsOfflineModeOmitChunkFromSearchIndex
type: section
...
previousSectionFile: adminGuide-adminReceiptSetup.md
previousSectionTitle: "Configuring customer printed receipts"
...
For more information on available actions during offline mode, see [Offline mode](devPortalPlatformGuideNetworkConnectionsOmitChunkFromSearchIndex.html#platformOfflineMode) and for more on preventing network disruptions, see [Preventing a Network Disruption](https://central.toasttab.com/s/article/Preventing-a-Network-Disruption).
