...
> The authentication method described in this section is deprecated.
      The preferred authentication method for the Toast loyalty API is static
      API key authentication. For information about using static API
...
(3) The value value includes the public key string.
            ...
            validate the authentication tokens in a Toast platform loyalty
            transaction request.
