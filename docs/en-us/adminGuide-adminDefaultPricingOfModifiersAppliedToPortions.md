...
> **Important**
> 
> By default, a portion of a modifier is priced the same as a full serving of the modifier. This section describes that default behavior. If you want to alter the price of a modifier when it is applied to a portion, you can use the Price Multiplier setting described in [Altering the price of a modifier applied to a portion](docs/en-us/adminGuide-platformAlteringThePriceOfAModifierAppliedToAPortion).
