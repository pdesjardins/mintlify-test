...
When a Toast platform restaurant employee handles a sale
    ...
    for loyalty program transactions, see [Transaction types](apiDevGuide-apiLoyaltyTransactionDescriptions.html).
...
In your implementation of the Toast loyalty integration API, you
    ...
    example:
    `https://<em>myapi.mycompany.com</em>/<em>myendpointname</em>`.
