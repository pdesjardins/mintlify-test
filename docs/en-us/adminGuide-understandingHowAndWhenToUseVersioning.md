...
- Menu items, modifiers (see [Versioning menu items](versioningOfMenuItems.html) for more information)
...
- Menus, menu groups, and modifier groups (see [Versioning at the menu group and modifier group level](versioningAtTheMenuGroupAndModifierGroupLevel.html) for more information)
...
For more information on printer set up, see [Prep stations and printers for enterprises](managingPrepStationsAndPrintersForEnterprises.html).
