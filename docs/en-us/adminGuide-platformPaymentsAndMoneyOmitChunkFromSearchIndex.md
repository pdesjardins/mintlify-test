---
title: "Chapter 6. Payments and money"
id: platformPaymentsAndMoneyOmitChunkFromSearchIndex
type: chapter
documentId: adminGuide
parentSectionFile: adminGuide-index.md
parentSectionTitle: "Platform guide"
previousSectionFile: adminGuide-platformSettingsCopyReviewingActivityTable.md
previousSectionTitle: "Reviewing past copies made using the settings copy feature"
nextSectionFile: adminGuide-adminCreditCardsOmitChunkFromSearchIndex.md
nextSectionTitle: "Credit card payments"
externalReferences: [https://central.toasttab.com/s/article/Basic-Digital-Receipt-Configuration, https://central.toasttab.com/s/article/Guest-Pay-and-Dual-Reader-Functionality-with-Toast-Tap, https://central.toasttab.com/s/article/Card-Pre-Authorization-Configuration-Device-Setup, https://central.toasttab.com/s/article/House-Accounts-1492809352564, https://central.toasttab.com/s/article/Setting-Up-Other-Payment-Options]
procedures: 0
codeExamples: 0
---

# Chapter 6. Payments and money

## Payment workflows

### Payment workflow overview

The Toast POS platform supports multiple ways for restaurant guests to make payments. The following sections describe the available payment methods, and how each method is used, on a Toast POS device.

The following diagram shows the payment workflow for standard Toast POS payment types. The payment workflow for your restaurant might be different, based on your restaurant's configuration and custom payment types.



> **Note**
> 
> This diagram does not include all custom payment types. Your restaurant’s payment workflow may be different based on restaurant configuration.
![Image](https://doc.toasttab.com/doc/media/PWFWorkflowdiagram.png)
...
| Status | Description | 
| --- | --- |
| Enabled | - Guests select a tip amount.
- The POS app displays Text, Email, and Printreceipt options on the guest-facing display, Toast Go, and flip tablet devices.
...
- The payment screen does not show the optional Tip box seen when digital receipts are disabled.
 ...
 | 
| Disabled | - For credit payments, a guest copy and a merchant copy are printed.
...
Refunding a guest is one of the most common actions taken on a point of sale system. Most commonly, a refund is issued if an incorrect payment type is used, or to resolve guest issues. For more information about refunds, see [Refunds](adminRefundsOmitChunkFromSearchIndex.html#adminRefundPermissionsLimitations).
...
If Digital Receipts are not enabled, and a printer is configured, a Merchant Copy and a Customer Copy of the receipt are printed. For more information about Digital Receipts see [Digital receipts and printed receipts](platformPaymentsAndMoneyOmitChunkFromSearchIndex.html#platformPwfDigitalReceipts).
...
If your restaurant has enabled digital receipts and you have configured a printer, the Toast POS device will print a Merchant Copy and a Customer Copy of the receipt. For more information about Digital Receipts see [Digital receipts and printed receipts](platformPaymentsAndMoneyOmitChunkFromSearchIndex.html#platformPwfDigitalReceipts).
...
3. Enter the guest's account number and select Done or select Lookup to [locate the guest account](platformPaymentsAndMoneyOmitChunkFromSearchIndex.html#platformLookUpHouseAccount).
