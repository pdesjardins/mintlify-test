...
**Example 3.12. POST request message body to create a dine-in order with payment
      information**
...
(2) The GUID of the menu group for the menu item selected for this
          check. For example, a menu might include a menu group named
          "appetizers" or "drinks."

(3) The GUID of the menu item selected for this check. For
          example, a menu item might be "spinach dip" or "lemonade."

(4) The number of the menu items selected for this check. For
          example, a check might include a "lemonade" menu item selection and
          a quantity of three, for a party of three customers.
 ...
 You do not need to include payment information to create an
          ...
          /prices endpoint of the orders API. For more
          information, see Getting check prices before you submit an order.

(6) The date and time that the customer presented payment for the
          check.

(7) One of the enumerated payment categories used by the Toast
          platform. The OTHER payment category includes payments
          processed outside of the Toast platform, for example by third-party
          services.

(8) The currency value of the payment, excluding tips.

(9) The GUID of the specific alternate payment type configured for
          ...
          OTHER payment category. Use alternative payment types
          if you process your payments outside of The Toast credit cards
          API.

(10) The currency value of the gratuity included with the
          payment.

(11) The currency value presented by the customer to provide the
          payment. Do not include the tip in the amountTendered
          value.
...
**Example 3.13. Orders endpoint response for a dine-in order with an alternative
      payment**
...
(2) The date and time that the order was created.
 ...
 The restaurant business date on which the order was fulfilled.
          The restaurant business date can be different than the calendar
          dates when the order is created, paid, and closed. For example, if a
          restaurant business day extends after midnight, an order that is
          created after midnight might have a businessDate value
          that is one day earlier than the calendar date when the order was
          created.

(4) Information about payments made for this check.

(5) The date and time that the check was added to the
          order.

(6) The date and time that the customer made a payment for the
          check.

(7) The date and time that the check was completely fulfilled and
          paid.

(8) The date and time that information about the check was changed
          most recently.

(9) The date and time that all checks in the
          order were completely paid.

(10) The date and time that all checks in the
          order were completely fulfilled and paid.

(11) The date and time that information about the order was changed
          most recently.
