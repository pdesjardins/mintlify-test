...
(1) Use the
            ...
            retrieve cash deposits. The GUID must be for an individual
...
(2) Use the businessDate request
            ...
            which the cash deposits were created.
...
(3) The amount of the deposit. The amount value
            must be greater than zero.

(4) The GUID or external identifier of the restaurant employee
            who created the cash deposit.

(5) The GUID of the deposit entry that was undone. The value is
            null if this deposit entry does not undo a previous
            deposit entry.
