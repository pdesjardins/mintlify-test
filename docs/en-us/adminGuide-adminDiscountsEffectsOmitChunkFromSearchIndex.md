---
title: "Effects of applied discounts"
id: adminDiscountsEffectsOmitChunkFromSearchIndex
type: section
documentId: adminGuide
parentSectionFile: adminGuide-adminDiscountsIntroOmitChunkFromSearchIndex.md
parentSectionTitle: "Chapter 9. Discounts"
previousSectionFile: adminGuide-adminAutoApplyDiscounts.md
previousSectionTitle: "Automatically applying discounts"
nextSectionFile: adminGuide-adminDiscountExclusivity.md
nextSectionTitle: "Exclusive and nonexclusive discounts"
keywords: [effects,applied,discounts]
procedures: 0
codeExamples: 0
---
...
If you [consolidate menu items](devPortalPlatformGuideUiOptionsOmitChunkFromSearchIndex.html#configCombineItems), you can use the Consolidate discounts setting to set how to apply an item-level fixed currency discount to a consolidated item.
