...
For more information on available actions during offline mode, see [Offline mode](platformOfflineMode.html) and for more on preventing network disruptions, see [Preventing a Network Disruption](https://central.toasttab.com/s/article/Preventing-a-Network-Disruption).
