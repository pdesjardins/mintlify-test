...
Then you must, at a minimum, have **POS Access**and **Delivery Access** permissions in Boston and **POS Access** permissions in Burlington in order to edit the employee's email and POS access code.
