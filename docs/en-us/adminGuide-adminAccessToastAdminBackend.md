...
After you sign in, your assigned access permissions determine the set of options that appear. For more information, see the [Access Permission Reference](adminPermissions.html).
