...
(2) The GUID for the labor reporting data request, also called
...
For more information about the values in the response, see
        [Understanding the labor reporting data](apiDevGuide-apiAnalyticsLaborReportingDataUnderstandingData).
