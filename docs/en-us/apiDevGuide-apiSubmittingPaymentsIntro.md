...
If you use the Toast platform as your credit card payment processor,
  you [submit
  payments through Toast's credit card API](apiDevGuide-authorizingCcPayments).
...
If you use a credit card payment processor outside of the Toast
  ...
  alternative payment types](apiDevGuide-apiCreatingAnOrderWithPaymentInformation). For example, you use an alternative
