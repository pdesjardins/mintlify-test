...
If Digital Receipts are not enabled, and a printer is configured, a Merchant Copy and a Customer Copy of the receipt are printed. For more information about Digital Receipts see [Digital receipts and printed receipts](docs/en-us/adminGuide-platformPwfDigitalReceipts).
...
If your restaurant has enabled digital receipts and you have configured a printer, the Toast POS device will print a Merchant Copy and a Customer Copy of the receipt. For more information about Digital Receipts see [Digital receipts and printed receipts](docs/en-us/adminGuide-platformPwfDigitalReceipts).
...
3. Enter the guest's account number and select Done or select Lookup to [locate the guest account](docs/en-us/adminGuide-platformPwfTenders#platformLookUpHouseAccount).
