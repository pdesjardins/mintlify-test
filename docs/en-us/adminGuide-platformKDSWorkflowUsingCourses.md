...
> **Note**
> 
> You can configure orders to be marked as ready on Orders Hub when they are fulfilled on the expediter KDS device. For more information, see [Marking KDS-fulfilled orders as Order Ready](docs/en-us/adminGuide-platformUsingOrdersHub#platformMarkingKDSOrdersAsOrderReady).
