...
- The employee that a cash drawer is locked down to must close the cash drawer during the shift review. For more information, see [Closing a cash drawer](adminCashDrawerPOSOperations.html#adminCashDrawerClose).
...
Only you will be able to open the cash drawer and you are required to close the drawer during shift review. For more information, see [Closing a cash drawer](adminCashDrawerPOSOperations.html#adminCashDrawerClose).
