...
<table className="">
  ...
  <tbody className="">
    <tr className="">
      <td className="px-4 py-4"><div className="space-y-4"><p className="text-base leading-relaxed">Orders</p></div></td>
      <td className="px-4 py-4"><div className="space-y-4"><p className="text-base leading-relaxed">Retrieve all orders from the previous day using the <code className="font-mono text-sm">/ordersBulk</code> endpoint of the orders API.</p> <p className="text-base leading-relaxed"><a href="apiDevGuide-apiOrdersGetDetailedInfoAboutMultipleOrders" className="">More information</a></p> <blockquote><strong>Note</strong> Toast support recommends using the <a href="apiDevGuide-devOrdersWebhookRef#apiOrdersWebhookOrderUpdated" className="">orders updated webhook</a> to receive order updates as they occur instead of pulling order updates with the <code className="font-mono text-sm">/ordersBulk</code> endpoint. </blockquote> </div></td>
