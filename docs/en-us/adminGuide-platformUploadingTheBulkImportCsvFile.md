...
### Uploading the bulk import CSV file
...
For more information about resolving data validation and import operation failures, see [Fixing import failures](platformFixingImportFailures.html).
