...
1. On a Toast POS device, open the **Payment Terminal** screen and select the magnifying glass icon to open the search function, or from the **Quick Order**or **Table Service** screen, select the **All checks** button to begin searching.
...
1. On a Toast POS device, open the **Quick Order**or **Table Service** screen.
