...
- Delivery status or payment status. For a full list of delivery statuses available for orders fulfilled by Toast Delivery Services (TDS), see [Toast Delivery Services statuses](docs/en-us/adminGuide-platformManagingDeliveryOrders#platformTDSStatusReference).
