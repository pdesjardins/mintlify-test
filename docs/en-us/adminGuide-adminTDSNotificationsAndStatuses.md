---
title: "TDS notifications and statuses"
id: adminTDSNotificationsAndStatuses
type: section
...
previousSectionFile: adminGuide-adminConfigureDeliveryOnOnlineOrderingDashboard.md
previousSectionTitle: "Configuring delivery settings on the online ordering dashboard"
nextSectionFile: adminGuide-platformOffPremiseOfflineModeOmitChunkFromSearchIndex.md
...
- Pick-up notification: This message is sent when the driver has picked up the guest's order.


- Rating notification: This message is sent when the guest's order has been marked as delivered. There is an option to rate the delivery experience.
...
For more information about TDS statuses, see [Toast Delivery Services statuses](platformOffPremiseDiningOmitChunkFromSearchIndex.html#platformTDSStatusReference).
