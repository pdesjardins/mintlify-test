...
| Add credit value to a guest record or approve a transaction that adds guest credit value started by another employee. For more information, see [Adding credit value](docs/en-us/adminGuide-adminAddingCustomerCreditValue). | Customer Credits & Reports | 

For more information, see the [Access Permission Reference](docs/en-us/adminGuide-adminPermissions).
