...
| Add credit value to a guest record or approve a transaction that adds guest credit value started by another employee. For more information, see [Adding credit value](adminAddingCustomerCreditValue.html). | Customer Credits & Reports | 

For more information, see the [Access Permission Reference](platformEmployeesOmitChunkFromSearchIndex.html#adminPermissions).
