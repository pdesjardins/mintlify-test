...
previousSectionFile: apiDevGuide-apiPartnersGettingAccessibleRestaurants.md
previousSectionTitle: "Location access"
nextSectionFile: apiDevGuide-apiEnvironments.md
...
> **Note**
> 
> Your developer portal account is created by the Toast
          Developer Relations team during onboarding, once you are approved as
          a Toast integration partner. For more information, see [Integration partnership process](apiDevGuide-integrationDevProcess).
> For developer portal account assistance, visit the [Toast
          Integrations Community Forum](https://developers.toasttab.com/hc/en-us/community/topics) and open a support request with
          the Toast Developer Relations team. 
...
**Procedure 1.3. To activate your developer portal account**
...
> **Note**
> 
> To get access to the environment selector, open a support
          request with the Toast Developer Relations team. For more
          information, see [Getting help with your integration](apiDevGuide-apiDeveloperPortal#apiDeveloperPortalMarketplaceListingHelpLinks).


The environment selector allows you to manage
        environment-specific data. You can switch between sandbox and
        production [environments](apiDevGuide-apiEnvironments) using the environment
...
The Documentation button on the top
        ...
        Documentation site](apiDevGuide-index). The site has links to various
...
The Credentials page contains your API
      ...
      credentials, see [Authentication and restaurant access](apiDevGuide-authentication).
...
> **Note**
> 
> Rotating your client secret terminates the existing client
        secret for Toast API access and creates a new client secret to replace
        it. The active authentication token generated using your credentials
        is valid until it expires or is replaced with a new authentication
        token.
...
The Scopes page contains the API scopes
        ...
        more information, select the [Scope Descriptions](apiDevGuide-apiScopes) link.
...
The API access endpoint page displays the endpoint you can use
        ...
        [Environments](apiDevGuide-apiEnvironments).
...
You can edit your integration’s sandbox or production marketplace
      listing using the [environment
      selector](apiDevGuide-apiDeveloperPortal#apiDeveloperPortalEnvironmentSelector). Select the environment to edit that environment’s
...
On the Toast Partner Integrations marketplace
      ...
      edit how your integration’s listing appears on Toast Partner
      Integrations by selecting the Edit
      details button.

**Procedure 1.4. To edit your integration listing**



> **Note**
> 
> You can proceed forward through the setup process by selecting
          the Continue button or go back to the previous
          section by selecting the Back button.
...
- Available in: This field is
                  ...
                  integration’s country availability, select the
...
- Company website URL: This is the
                  website URL of your integration’s website.
...
> **Note**
> 
> A preview of your Toast Partner
                Integrations listing appears to the right of the
                Marketplace listing section. The preview
                displays your logo, short description, and categories. Buttons
                and links are disabled in the preview. Your integration's
                description and image are visible to all Toast customers who
                subscribe to Toast Partner
                Integrations.


- Application logo: Delete your
                  application image, or upload or drag and drop a new image
                  that will appear on your integration’s Toast
...
> **Note**
> 
> You can also set optional secondary action labels
                    and references that will appear on your Toast
                    Partner Integrations listing. To edit your
                    secondary action label or action reference, select the
                    Open a support ticket link to open a
                    support request with the Toast Developer Relations
                    team.
...
- Learn more about what happens when a [restaurant
            adds your integration](apiDevGuide-apiPartnersGettingAccessibleRestaurants) in Toast Partner
            Integrations.


- Learn more about the [Partners webhook](apiDevGuide-apiPartnersWebhook) and how to use it to be notified
...
**Procedure 1.5. To add a new payment method configuration**
...
The Webhooks page displays all your webhook
      ...
      webhooks, see [Webhooks reference](apiDevGuide-apiWebhooksReference).
...
**Procedure 1.6. To add a new webhook subscription**
...
- Event category: Select your event
                ...
                [Webhooks reference](apiDevGuide-apiWebhooksReference).
...
**Procedure 1.7. To filter webhook events**
...
- Number of webhook attempts. For more information about
                retry attempts, see [Retry support](apiDevGuide-apiRetrySupport).
...
> **Note**
> 
> You can edit webhook details on the Edit
          webhook page. You can navigate to the Edit
          webhook page by selecting the Edit
          button next to the webhook link on
          Webhooks page or by selecting the
          Edit webhook button on the Webhook
          events page.
...
**Procedure 1.8. To edit webhook details**
...
> **Note**
> 
> The Activity Log page does not track user
        actions taken in Toast Web.


The Activity Log page displays a list of the
      instances when the client secret was rotated. You can rotate the client
      secret on the [Credentials](apiDevGuide-apiDeveloperPortal#apiDeveloperPortalCredentials) page.
...
You can view the Developer guide by selecting the User
      ...
      [Toast
      developer portal overview](apiDevGuide-apiDeveloperPortal).
