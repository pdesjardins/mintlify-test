...
For more information about selecting required items for discounts, see [Choosing the required items for a discount](docs/en-us/adminGuide-adminDiscountRequiredItemsAbout).
...
For more information about required items for discounts, see [Choosing the required items for a discount](docs/en-us/adminGuide-adminDiscountRequiredItemsAbout).

## Setting the maximum quantity to apply the discount to

You can configure a combo discount as a bulk discount, which includes the minimum and maximum quantity to apply the discount to. See [Bulk discounts](docs/en-us/adminGuide-adminBulkDiscounts).
