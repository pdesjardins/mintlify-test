...
This additional control over visibility is currently restricted to menus. It is not yet available for menu groups, menu items, modifier groups, or [modifier option item references](adminPricingModifierOptions.html#adminUnderstandingAModifierOptionsItemReference).
