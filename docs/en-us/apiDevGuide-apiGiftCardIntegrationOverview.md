...
> **Note**
> 
> Toast Gift Card balances cannot be retrieved using the Toast
      APIs.
...
> **Note**
> 
> Toast Online Ordering functionality supports gift card
      integrations only if your integration supports verification codes
      (PINs). For more information, see [Verification Codes (PINs)](apiDevGuide-apiGiftCardIntegrationWorkflow#apiGiftCardIntegrationVerificationsCodes).
