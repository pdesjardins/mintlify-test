...
> **Note**
> 
> Toast Online Ordering functionality supports gift card integrations only if your integration supports verification codes (PINs). For more information, see [Verification Codes (PINs)](docs/en-us/apiDevGuide-apiGiftCardIntegrationWorkflow#apiGiftCardIntegrationVerificationsCodes).
