...
(1) Send a POSTrequest to the /era/v1/guest/payments/{timeRange}endpoint of the analytics API. The {timeRange}in this example is week.
...
(3) The start date of the time range for the guest reporting data, in YYYYMMDDformat.

(4) The end date of the time range for the guest reporting data, in YYYYMMDDformat.
