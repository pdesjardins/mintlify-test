...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Shift Review </td>
      <td>**Gives access to**<ul><li>Employee's shift review report.</li><li>On the Toast POS home screen, gives access to Manager Activities &gt; Shift Reviewand Manager Activities &gt; Time Cards.</li></ul>**Assign to**<ul><li>Managers</li></ul></td>
    </tr>
    <tr>
