...
(1) Send a POSTrequest to the /era/v1/metrics/{timeRange}endpoint of the analytics API. The {timeRange}is set to day.

(2) Use the aggregateByquery parameter set to HOURto group the aggregated sales reporting data by hour instead of day.
...
(5) Include details about the requested aggregated sales reporting data in the message body. For an example of the message body, see Message body for the aggregated sales reporting data request using aggregateByand groupBy.
...
(1) The start date of the time range for the aggregated sales reporting data, in YYYYMMDDformat.

(2) The end date of the time range for the aggregated sales reporting data, in YYYYMMDDformat.
...
(1) Send a POSTrequest to the /era/v1/metrics/{timeRange}endpoint of the analytics API. The {timeRange}in this example is day.

(2) Use the aggregateByquery parameter set to HOURto group the aggregated sales reporting data by hour. For more information, see Using the aggregateByquery parameter .
...
(1) The start date of the time range for the aggregated sales reporting data, in YYYYMMDDformat. The endBusinessDatevalue is optional for requests using the daytime range.
...
(1) Send a GETrequest to the /era/v1/metricsendpoint of the analytics API.
