...
> **Important**
> 
> Adding restaurant GUIDs to both `restaurantIds`and `excludedRestaurantIds` results in an error. For more information, see [Creating a request for aggregated sales reporting data](docs/en-us/apiDevGuide-apiAnalyticsMetricsReportingDataCreateRequest).
