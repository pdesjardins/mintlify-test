...
> **Note**
> 
> For more information on the channel visibility settings in the
          Toast Web, see [Specifying ordering channel visibility](adminGuide-adminSpecifyingOrderingChannelVisibility) (for menu
          builder users) and [Visibility overview](adminGuide-adminMenuVisibilityOverview) (for classic menu page
          users).
