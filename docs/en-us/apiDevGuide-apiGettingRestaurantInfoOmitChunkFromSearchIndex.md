---
title: "Getting restaurant info"
id: apiGettingRestaurantInfoOmitChunkFromSearchIndex
type: section
...
-H "Toast-Restaurant-External-ID: 76cb1b05-cb1e-4adf-863a-b2a94a5ecdcf" \[(1)](apiDevGuide-apiGettingRestaurantInfoOmitChunkFromSearchIndex.html#d1e84161282B4-F46D-4270-AE0F-A6973EF18C80-co)
https://*`[toast-api-hostname]`*/restaurants/v1/groups/ae6c32fe-f4d2-4dcc-aa82-f30edac96296/restaurants[(2)](apiDevGuide-apiGettingRestaurantInfoOmitChunkFromSearchIndex.html#d1e89161282B4-F46D-4270-AE0F-A6973EF18C80-co)
```



(1) Use the Toast-Restaurant-External-IDrequest parameter to specify the GUID of one restaurant location in the restaurant management group.
...
[
  {
    "guid": "34ac7aaf-7178-4c6f-af63-c42ebc7e91f7"[(1)](apiDevGuide-apiGettingRestaurantInfoOmitChunkFromSearchIndex.html#d1e106161282B4-F46D-4270-AE0F-A6973EF18C80-co)
  },
  {
...
(1) The guidvalue contains the unique Toast POS identifier for a restaurant location in the restaurant management group. In this example, the request returns four restaurant locations.
