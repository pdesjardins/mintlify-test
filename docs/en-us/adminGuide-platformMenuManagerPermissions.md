...
To access the menu manager itself, you must have the **4. Restaurant Admin &gt; 4.5 Edit Full Menu**permission at the location you have logged into (also known as the [session restaurant](adminGuide-index)). If you do not have this permission, the menu manager does not appear in Toast Web.
...
If you have the **4.5 Edit Full Menu**permission to the:
