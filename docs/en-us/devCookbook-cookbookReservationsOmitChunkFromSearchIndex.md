---
title: "Reservations"
id: cookbookReservationsOmitChunkFromSearchIndex
type: section
...
previousSectionFile: devCookbook-apiHowToBuildACrmGuestEngagementIntegration.md
previousSectionTitle: "Building a CRM & Guest Engagement integration"
...
- `labor:read` (this is optional. For more information, see [Determine what optional functionality you will support](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegWriteOptional))


- `labor.employees:read` (this is optional. For more information, see [Determine what optional functionality you will support](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegWriteOptional))
...
- `orders.orders:write` (for read-write integration only. For more information, see [Building a read-write reservation integration](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegWrite))
...
- [Read-only reservation integration](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegReadOnly): Manage reservations within your system without sharing details with the Toast platform.


- [Read-write reservation integration](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegWrite): Your integration will pass reservation information to the Toast platform.
...
- Alternative payment types (this is optional. For more information, see [Determine what optional functionality you will support](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegWriteOptional))
...
- Service charges (this is optional. For more information, see [Determine what optional functionality you will support](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegWriteOptional))
...
Ensure your integration adheres to the endpoint specific rate-limit for the `/ordersBulk` endpoint when retrieving order data. For more information about Toast rate limits, see [Rate limiting](apiRateLimiting.html).

To understand which order elements are relevant to your integration, see [Understanding reservation order data](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegData).

#### Building a read-only reservation integration

Since your integration will handle reservations entirely within your system, you will rely on the response from the orders API to obtain the necessary order data for updating reservation information in your system. For more information, see [Understanding reservation order data](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegData).

#### Building a read-write reservation integration

If your integration is passing reservation information to the Toast platform, you will submit an order without menu item selections and include the required information listed below. Your integration will do this by sending a `POST` request to the [`/orders`](https://doc.toasttab.com/openapi/orders/operation/ordersPost/)endpoint of the orders API. For more information, see [Creating orders](portalCreatingAndUpdatingOrdersOmitChunkFromSearchIndex.html#apiCreatingOrders).
...
For more information about where tab names appear in the Toast platform, see [Guest personal identifiable information](devPortalPlatformGuideOrdersOmitChunkFromSearchIndex.html#platformOrdersPii).
...
To retrieve your alternative payment type identifier, send a `GET` request to the `/alternativePaymentTypes`endpoint of the configuration API and submit this payment type in the `payments` object of your reservation order. For more information, see [Alternative payment types](apiCreatingAnOrderWithPaymentInformation.html) to learn more about submitting payments using the orders API.
...
- Collect the [reservation information](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegWriteRequired) required by Toast for order submission.
...
3. Update the reservation in your system using the information outlined in [Understanding reservation order data](cookbookReservationsOmitChunkFromSearchIndex.html#reservationIntegData).
...
{
  "diningOption": {
    "guid": "374d500f-c6d8-44d0-a18d-43fe5e7f750c"[(1)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-diningOption-co)
  },
  "revenueCenter": {
    "guid": "81665a60-c20d-41da-a362-6474eab830d3"[(2)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-revenueCenter-co)
  },
  "table": {
    "guid": "880a2f72-8960-4a3f-b2a2-60b7a19975e7"[(3)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-table-co)
  },
  "numberOfGuests": 4,[(4)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-numberOfGuests-co)
  "server": {
    "guid": "90d97fb8-931f-4196-aae9-d71bbcd5d3df"[(5)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-server-co)
  },
  "checks": [
    {
      "tabName": "Reservation Partner - Ann M"[(6)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-tabName-co)
    },
    {
      "appliedServiceCharges": [
        {
          "serviceCharge": {
            "guid": "9b2dd3cc-f4ab-4586-8c5a-2bbf6a9eef8d"[(7)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-serviceCharge-co)
           }
         }
       ]
     },

    {
      "payments": [
        {
          "type": "OTHER",
          "amount": "20.00",[(8)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-deposit-co)
          "tipAmount": "0.00",
          "otherPayment": {
            "guid": "40dbc841-7f29-47d0-9834-9cf9c5b591d2"[(9)](devCookbook-cookbookReservationsOmitChunkFromSearchIndex.html#res-otherPayment-co)
          }
        }
      ]
    }
...
See [Building a sales report](apiIntegrationChecklistAccounting.html) for additional guidance on order reporting.
