...
> **Note**
> 
> To access third-party online ordering configuration settings, you must have the 6.6 Restaurant Operations Setuppermission. For more information about permissions, see [Web setup access permissions](docs/en-us/adminGuide-adminPermissions#adminWebSetupAccessPermissions).
