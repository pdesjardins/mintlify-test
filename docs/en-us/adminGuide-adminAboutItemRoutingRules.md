...
> **Note**
> 
> If you use the Dining Option[additional modifier group](docs/en-us/adminGuide-adminUiOptionsReference#configAdditionalModifierGroups) to identify a different dining option for an item in an order, that item is routed to the same prep stations as the other items in the order.
...
For more information about how you configure dining options, see [Dining Options](docs/en-us/adminGuide-adminKitchenDiningRoomReference#configDiningOptions).

You can also use KDS devices to display tickets only for specified dining options. For more information, see [Filtering tickets on a KDS device](docs/en-us/adminGuide-adminKdsTicketDisplayOptions).
...
You can also use KDS devices to display tickets only for specified service areas. For more information, see [Filtering tickets on a KDS device](docs/en-us/adminGuide-adminKdsTicketDisplayOptions).
...
6. From the Condition list, select the [dining option](docs/en-us/adminGuide-adminKitchenDiningRoomReference#configDiningOptions) or service area that your rule applies to.
