...
- [Voided payments](docs/en-us/apiDevGuide-apiPaymentntInformation#apiVoidedPayments)


- [Refunded payments](docs/en-us/apiDevGuide-apiPaymentntInformation#apiRefundedPayments)
