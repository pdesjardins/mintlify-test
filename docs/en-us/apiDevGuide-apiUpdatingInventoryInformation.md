...
> **Note**
> 
> For information on getting inventory information, see [Getting stock using the stock webhook](apiUsingTheStockWebhook.html) and [Getting stock information using the stock API](apiUsingTheStockApi.html).
