...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>**Gives access to **orders placed by other employees for review. Must be assigned along with Payment Terminal Mode. <br/> On the Payment Terminal screen, updates the Overflow menu (the ⋮ icon) to include an option to switch between Show My Checks and Show All Checks.  <br/> On the Table Service screen, employees can view another employee's guest order details. <br/> **Assign to **managers and employees who need to review all open, paid, and closed orders, not just their own.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>No Sale</td>
      <td>**Gives access to **cash drawers at any time. Allows employees to [undo cash entries](adminGuide-adminUndoingOperations) in a cash drawer. Must be assigned along with Quick Order Mode. <br/> On the Quick Order screen, employees with this permission can complete a No Sale action without asking for a manager's help. <br/> **Assign to **employees who need to be able to open the cash drawer when they do not have a payment to complete. <br/> For more information, see [Cash management overview](adminGuide-adminCashManagementOverview).</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Employee Info</td>
      <td>**Gives access to **Employees > Employee management > Employees and Toast account > Internal tools > Publish config in Toast Web. <br/> Employees with this permission can use all options to create user accounts, view and edit all basic user account information including email addresses, names, ID numbers, and POS passcodes, and disable or delete user accounts.  <br/> If features for assigning permissions or jobs are needed, assign with Employee Jobs & Wages or User Permissions. <br/> **Assign to **managers and employees who need to add or update employee account information.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>**Gives access to **configuration, management, and reporting options for house accounts. <br/> In Toast Web, gives access to Payments > Payment methods > House accounts. When assigned with Sales Reports, also gives access to the Reports > Accounts > House Account report. <br/> **Assign to **owners and employees who need to create, invoice, and update house accounts.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>**Gives access to**<ul><li>Integrations > Data Extensions > Manage data extensions </li><li>The Data Extension View permission allows employees to view saved, published, and resolved data extension sets.</li></ul></td>
    </tr>
    <tr>
      <td>Data Extension Edit </td>
      <td>**Gives access to**<ul><li>Integrations > Data Extensions > Manage data extensions </li><li>The Data Extension Edit permission allows employees to view saved, published, and resolved data extension sets as well as create and update data extension sets.</li></ul></td>
    </tr>
  </tbody>
</table>
