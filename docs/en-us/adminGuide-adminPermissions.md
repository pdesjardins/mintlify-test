...
<table className="">
  ...
  <tbody className="">
    ...
    <tr className="">
      ...
      <td className="px-4 py-4"><div className="space-y-4"> <p className="text-base leading-relaxed"><strong className="font-semibold">No longer active </strong> This permission is no longer checked by the Toast platform and has no effect on feature access. You cannot assign this permission to new employees. It may still appear on employees who were assigned this permission before February 2026. Access is now controlled by the HR+ role in Toast Payroll.</p>  <p className="text-base leading-relaxed"><strong className="font-semibold">Previous purpose </strong> Previously gave access to the Accounting pages related to payroll, which granted the ability to manage integrations between Toast Payroll and your accounting software.</p> </div></td>
    </tr>
    <tr className="">
      <td className="px-4 py-4"><div className="space-y-4"><p className="text-base leading-relaxed">Accounting Sales Setup</p></div></td>
      <td className="px-4 py-4"><div className="space-y-4"> <p className="text-base leading-relaxed"><strong className="font-semibold">No longer active </strong> This permission is no longer checked by the Toast platform and has no effect on feature access. You cannot assign this permission to new employees. It may still appear on employees who were assigned this permission before February 2026. Access is now controlled by the **Financial Accounts** permission.</p>  <p className="text-base leading-relaxed"><strong className="font-semibold">Previous purpose </strong> Previously gave access to the Accounting pages related to sales, which granted the ability to manage integrations between the Toast platform and your accounting software.</p> </div></td>
    </tr>
    <tr className="">
      ...
      <td className="px-4 py-4"><div className="space-y-4"> <p className="text-base leading-relaxed"><strong className="font-semibold">No longer active </strong> This permission is no longer checked by the Toast platform and has no effect on feature access. You cannot assign this permission to new employees. It may still appear on employees who were assigned this permission before February 2026. Access is now controlled by the **Financial Accounts** permission.</p>  <p className="text-base leading-relaxed"><strong className="font-semibold">Previous purpose </strong> Previously gave access to the Accounting pages related to accounts payable, which granted the ability to manage integrations between the Toast platform and your accounting software.</p> </div></td>
    </tr>
  </tbody>
</table>
</div>
