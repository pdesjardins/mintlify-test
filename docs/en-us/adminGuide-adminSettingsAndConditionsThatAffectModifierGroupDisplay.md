...
**Settings on the UI options page **The **Front of house &gt; Order screen setup &gt; UI options** page contains a **Modifier ordering priority** option in the **Order screen**section:
