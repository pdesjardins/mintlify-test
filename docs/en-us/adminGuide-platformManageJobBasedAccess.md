...
6. Choose Toast account &gt; Publishing &gt; Publish config to open the Publish configpage. Publish your changes for each location. For more information, see [Using the Publish Config page](docs/en-us/adminGuide-platformHowToPublish#platformPublishingPublishConfigPage).
