...
(1) Send a POSTrequest to the /era/v1/payout/{timeRange}endpoint of the analytics API. The {timeRange}in this example is day.
...
(4) Include details about the requested payout reporting data, organized by settled date, in the message body. The following example is the message body for this curl command example.
...
(1) Send a GETrequest to the /era/v1/payoutendpoint of the analytics API.
