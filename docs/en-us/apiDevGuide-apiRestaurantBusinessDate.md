...
> **Note**
> 
> Your restaurant's Business Day Cutoff and
        Time Zone configurations can only be updated by
        Toast Support.
...
> **Note**
> 
> The Toast platform will not close unpaid orders. Unpaid orders
          remain open until they are resolved either by being paid or
          voided.
