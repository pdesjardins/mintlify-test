...
To set a menu item's stock status in the Toast app, a restaurant uses Quick Editmode (described in this [Toast Central article](https://central.toasttab.com/s/article/Quick-Edit-Mode-1492794309057)). To set it in Toast Web, the restaurant uses the Inventorysection of the menu item's details page.
