...
If a menu item or modifier uses the location-specific pricing strategy, the location-specific prices must be base prices or menu-specific prices (in other words, the location-specific prices cannot use one of the other [advanced pricing strategies](adminToastPosPricingFeatures.html)).
