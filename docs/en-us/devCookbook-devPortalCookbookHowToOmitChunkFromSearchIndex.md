---
title: "Chapter 1. Recipes"
id: devPortalCookbookHowToOmitChunkFromSearchIndex
type: chapter
documentId: devCookbook
parentSectionFile: devCookbook-index.md
parentSectionTitle: "Integration how-to guides"
previousSectionFile: devCookbook-devPortalCookbookIntro.md
...
> **Note**
> 
> This section does not apply to the [gift card API](apiBuildingGiftCardIntegrationOmitChunkFromSearchIndex.html#apiGiftCardIntegrationOverview) or the [loyalty API](apiBuildingALoyaltyIntegrationOmitChunkFromSearchIndex.html#apiLoyaltyProgramIntegrationOverview).
