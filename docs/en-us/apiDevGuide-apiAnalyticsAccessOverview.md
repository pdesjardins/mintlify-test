...
If you are a Toast customer looking for insight into your management
    group’s performance, you can use analytics API access to get read-only
...
- You must have the following permissions to all locations in
          the management group: 

- 4.1 Sales Reports


- 4.2 Menu Reports ( + Inventory / Menusphere
              Reporting)
...
> **Note**
> 
> Do not provide your client secret or authentication token in
        plain text if posting in the Toast Integrations Community
        Forum.
