...
For more information on configuring BOGO discounts, see [Configuring a BOGO discount](adminDiscountsConfigureBogo.html).
...
For more information on configuring combo discounts, see [Configuring a combo discount](adminDiscountsConfigureCombo.html).
