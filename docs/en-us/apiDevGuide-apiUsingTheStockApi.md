...
> **Note**
> 
> For more information on how to change a menu item's inventory information using the stock API's `/inventory/update`endpoint, see [Updating stock](docs/en-us/apiDevGuide-apiUpdatingInventoryInformation). For more information on how to change a menu item's inventory status using Toast Web, see [Menu item inventory overview](docs/en-us/adminGuide-adminMenuItemInventoryOverview).
...
For information on these two identifier types, see [Toast identifiers](docs/en-us/apiDevGuide-portalToastIdentifiers).
