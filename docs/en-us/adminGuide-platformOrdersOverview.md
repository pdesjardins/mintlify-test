...
id: platformOrdersOverview
type: section
documentId: adminGuide
parentSectionFile: adminGuide-platformOrdersOverviewOmitChunkFromSearchIndex.md
parentSectionTitle: "Orders overview"
previousSectionFile: adminGuide-platformOrdersOverviewOmitChunkFromSearchIndex.md
previousSectionTitle: "Orders overview"
...
- Applicable taxes. See [Taxes](adminTaxesOverview.html).


- Discounts on the menu item selections and on the entire check. See [Discounts](platformDiscountsOverview.html).


- Service charges on the check. See [Service charges](adminServiceChargeOverview.html).


- Information about the guest. See [Guests](adminGuestDataOverview.html).
