...
- SHOULD ensure idempotency of update processing. When [retry
        support](apiDevGuide-apiRetrySupport) is implemented, it will be possible for updates to be
...
- SHOULD NOT return a 4xx response code. In general, the Toast
        ...
        [Retry support](apiDevGuide-apiRetrySupport) for more
        information.


- MUST be publicly accessible and should not require
        authentication. See [Message signing](apiDevGuide-apiMessageSigning) for information on verifying
        messages.
