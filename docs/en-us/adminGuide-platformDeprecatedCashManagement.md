...
3. Select the **View all printers** link. This opens the **Printers and cash drawers**page.
...
7. Configure the **Primary Cash Drawer**fields:
...
As the example shows, the **During Shift**buttons are disabled. The **End of Shift** buttons are described in [End of Shift operations](adminGuide-platformDeprecatedCashManagement#platformEndOfShiftOperations) and the **Adjust Start** button is described in [Adjust Starting Balance operation](adminGuide-platformDeprecatedCashManagement#platformAdjustStartOperation).
...
1. Select the **Tip Out**action.


2. From the **Select a server**drop-down, choose the server to whom the cash tips will be distributed.
...
1. Select the **Pay Out**action.


2. From the **Select a payout reason**drop-down, select a pre-configured reason.
...
2. Navigate to the **Cash Management**section and select **Pay Out**.
...
1. From the **Select a cash drawer**drop-down, select a cash drawer in which to make the pay out entry.
...
As a result, a **Pay Out** action for the amount is entered in the cash drawer, along with the name of the employee who made the pay out. This information (including the reason for the entry) will also be listed in the **Reports &gt; Cash and loss management &gt; Cash activity audit**report.
...
As a result, the cash drawer's starting balance is immediately adjusted. The cash drawer's **Starting Balance**field will have an "Adjusted" prefix (as shown in the following cropped example) to indicate that the starting balance was changed.
...
3. Select the **Customize shift review**button. Continue to the **Require shift review**screen, navigate to the **Require shift review **setting and select the **Shift review is required** option.


4. Continue to the **Close cash drawer**screen, navigate to the **Lock employee to cash drawer** setting and select the **Required - Employees assigned a drawer-lock job are required to lock themselves to a cash drawer** option.
