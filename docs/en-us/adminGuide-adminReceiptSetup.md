...
- Configure your printers by using the **Printers and Cash Drawers** page (choose the **Payments &gt; Checks & receipt setup &gt; Printers and cash drawers**menu).
...
5. Enter the **Advanced**configuration:
