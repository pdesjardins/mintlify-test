...
To configure receipts, you need Restaurant Admin > POS Setup permission to access the Receipt Setup Toast Web page. For more information, see the [Access Permission Reference](platformEmployeesOmitChunkFromSearchIndex.html#adminRestaurantAdminAccessPermissions).
