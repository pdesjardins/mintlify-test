...
With the [stock webhook](apiUsingTheStockWebhook.html), the Toast platform pushes updates to your system when the stock status of a menu item or modifier changes. This is the preferred method for getting information about changes to a menu item or modifier's inventory.
