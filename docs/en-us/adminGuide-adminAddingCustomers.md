---
title: "Adding a guest record"
id: adminAddingCustomers
type: section
...
previousSectionFile: adminGuide-adminSearchingGuestChecks.md
previousSectionTitle: "Searching for guest checks"
...
3. Enter a telephone number or tap **Name/Email**to enter a name or email address, and then tap the magnifying glass icon search for an existing guest record.
