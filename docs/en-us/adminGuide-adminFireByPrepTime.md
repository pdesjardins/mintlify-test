...
To configure your menu items to include prep times, you must have the 4. Restaurant Admin &gt; 4.5 Edit Full Menuaccess permission. For information about adding prep times to modifiers, see [Using prep times for modifiers](adminGuide-adminFireByPrepTime#adminUsePrepTimesModifiers).
...
> **Note**
> 
> Currently, in [grid view](adminGuide-platformKDSOverview#platformGridKDSOverview) you cannot fire a ticket that contains an unfired item. You can only fire an individual item if you have the Fulfill Itemsetting set to Enable individual item fulfillment.
