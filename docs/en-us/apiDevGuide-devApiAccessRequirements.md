...
- You must have the Manage Integrationspermission for the locations you want to add standard API access credentials to. For more information, see [Account admin access permissions](adminGuide-adminPermissions#adminAccountAdminAccessPermissions).
