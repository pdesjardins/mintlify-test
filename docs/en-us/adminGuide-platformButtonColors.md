...
previousSectionFile: adminGuide-platformFillingOutTheBulkImportSpreadsheet.md
previousSectionTitle: "Filling out a bulk import spreadsheet"
...
The following graphic shows the colors you can use in the [Button color](docs/en-us/adminGuide-platformFillingOutTheBulkImportSpreadsheet#platformBulkMenuImportButtonColor) column when creating new menu items, modifier groups, and modifiers with the advanced template.
