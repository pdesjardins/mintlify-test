...
The following graphic shows the colors you can use in the [Button color](adminGuide-platformFillingOutTheBulkImportSpreadsheet#platformBulkMenuImportButtonColor) column
    when creating new menu items, modifier groups, and modifiers with the
    advanced template.
