...
Send a `GET` request to the `/era/v1/menu/&#123;reportRequestGuid&#125;` endpoint to retrieve menu reporting data. The rate limit for this endpoint and method type is five requests per second and 30 requests per minute. For more information about API rate limits for the analytics API, see [Analytics API rate limits](apiDevGuide-apiAnalyticsRateLimiting).
...
```
    ...
    <tr className="">
      <td className=""><a href="#co-d1e6065F987D2F6-E937-4A8F-AC23-BD439B5BF371" className="">(1)</a></td>
    ...
    <tr className="">
      <td className=""><a href="#co-d1e6067F987D2F6-E937-4A8F-AC23-BD439B5BF371" className="">(2)</a></td>
    ...
    <tr className="">
      <td className=""><a href="#co-d1e6069F987D2F6-E937-4A8F-AC23-BD439B5BF371" className="">(3)</a></td>
...
For more information about the values in the response, see [Understanding the menu reporting data](apiDevGuide-apiAnalyticsMenuReportingDataUnderstandingData).
