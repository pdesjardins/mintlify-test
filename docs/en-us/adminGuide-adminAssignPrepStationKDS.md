...
1. [Create a production item](adminAssignPrepStationKDS.html#adminCreateProdItem) for each ingredient that you want to track on the KDS.


2. [Assign the production item](adminAssignPrepStationKDS.html#adminAssignProdItemQuantity) and its quantity to a menu item or modifier.


3. [Specify the production items](adminAssignPrepStationKDS.html#adminSpecifyProdItemDevice) that you want to see totaled on your KDS device.
