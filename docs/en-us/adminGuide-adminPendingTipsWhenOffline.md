---
title: "Pending tips when offline"
id: adminPendingTipsWhenOffline
type: section
...
previousSectionFile: adminGuide-adminCompletingShiftReviewOffline.md
previousSectionTitle: "Completing shift review offline"
...
The Shift Review screen on your Toast POS device displays your pending tips in the shift review report and in the Cash reimbursement step. In the shift review report, pending tips are shown under the Employee Accountheading. Any pending tips are displayed as: *`$`* in pending tips not included. For example, *`$123.47`* in pending tips not included.
