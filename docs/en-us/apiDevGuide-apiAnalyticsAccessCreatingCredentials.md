...
> **Note**
> 
> You can configure configure only one set of analytics API access
...
> **Note**
> 
> An active subscription to Toast Restaurant Management Suite
          Pro or higher is required.
...
You can choose to view your credentials in JSON format. JSON is
      ...
      token](apiDevGuide-authentication#apiAuthGetTokenRequest).
...
> **Note**
> 
> Active authentication tokens generated using your credentials
          will continue to be valid until they expire or are replaced with new
...
5. Select View secret. Your new client
          ...
          more information, see [Credential storage guidelines](apiDevGuide-authentication#apiAuthTokenStorage).
...
> **Note**
> 
> Deleting analytics API access credentials is permanent. You
