...
> **Note**
> 
> If you have the limited release **Send to**setting, you will see this instead of the **Send to Expediter** setting. Choose to send items to prep station, expediter, or both.
