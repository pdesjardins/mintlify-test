...
They also do not appear as an option when assigning prep stations to a KDS device. For more information, see [Assigning a KDS device to a prep station](adminAssignPrepStationKDS.html).
...
After you set up your prep stations, you can [assign KDS devices](adminAssignPrepStationKDS.html) to them (if applicable) and [add them to your menus](adminRoutingToPrepStations.html#adminAssignPrepStationMenu).
