...
- Shift operations, excluding the No saleaction
...
3. Select the type of Cash Inentry:
...
3. Select the type of Cash Outentry:
...
2. Select the Adjust Starting Balancebutton. This opens the Adjust Starting Balance dialog.
...
You can complete an Update Closing Balance action from the Cash drawer historypage in Toast Web.
...
2. Select Update Closing Balance button. This opens the Close Cash Drawerdialog.
