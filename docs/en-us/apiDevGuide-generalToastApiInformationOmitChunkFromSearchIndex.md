---
title: "General Toast API information"
id: generalToastApiInformationOmitChunkFromSearchIndex
type: section
...
previousSectionFile: apiDevGuide-apiAuthenticationRateLimit.md
previousSectionTitle: "Authentication rate limit"
...
- The [curl command-line program](https://curl.se/). You can use curlto send HTTP requests to a REST API server. The examples in this documentation use the curlprogram. Using curlcommands isn't a practical way to build a real API integration but it is an effective way to try requests and see what's in the communication between the client and the server.
