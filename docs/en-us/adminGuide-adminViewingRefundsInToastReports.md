...
3. [Locate the check](docs/en-us/adminGuide-adminIssuingARefund#adminToLocateACheckInToastAdminBackend).
...
Payments that are refunded using the custom amount refund type still appear in the [Payments Summary](docs/en-us/adminGuide-adminViewingRefundsInToastReports#adminSalesSummaryPaymentsSummary)table.
