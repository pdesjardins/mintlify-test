...
See [Effects of gratuity service charges](docs/en-us/adminGuide-adminServiceChargeType#adminGratuityServiceChargeEffects).
...
Optionally, you can configure the service charge to be [taxed](docs/en-us/adminGuide-adminServiceChargeCalculation#adminServiceChargeTaxes), using one or more of your configured tax rates.
