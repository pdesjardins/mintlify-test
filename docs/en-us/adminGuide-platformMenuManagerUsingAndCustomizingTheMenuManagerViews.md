...
When you select the name of a menu entity from the menu hierarchy table in **Full menu** view, a side panel opens with details for that entity. The side panel lets you quickly configure your menu entities without leaving **Full menu**view.
