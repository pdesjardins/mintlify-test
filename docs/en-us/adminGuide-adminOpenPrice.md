...
> **Note**
> 
> Open prices are not supported by Toast Online Ordering. If you use Toast Online Ordering, do not use the **Open Price**pricing strategy for any menu items that will be visible on your Toast online ordering website.
...
**Procedure 8.130. To enable open prices for a menu group or menu item**
...
**Procedure 8.131. To use open prices on the Toast POS app**
