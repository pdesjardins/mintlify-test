...
First, review the [loyalty integration overview](apiLoyaltyProgramIntegrationOverview.html) and [POS workflow](apiLoyaltyPosWorkflow.html) to understand the flow of information in a loyalty integration.
...
If your integration supports item-level discounts, you must use the [menus API](apiGettingMenuInformationFromTheMenusAPI.html)to save menu information so that restaurant administrators can map discounts from your service to menu items in the Toast platform.
