...
- [Order ready messaging](docs/en-us/adminGuide-platformUsingOrdersHub#platformConfiguringOrderReadyMessaging)


- [Marking KDS-fulfilled orders as Order Ready](docs/en-us/adminGuide-platformUsingOrdersHub#platformMarkingKDSOrdersAsOrderReady)
...
- `IN_PREPARATION`: The order is being actively worked on. This status corresponds to the [Active](docs/en-us/adminGuide-platformUsingOrdersHub#platformActiveOrders) status in Orders Hub.


- `READY_FOR_PICKUP`: The order is ready for guest pickup. This status corresponds to the [Order ready](docs/en-us/adminGuide-platformUsingOrdersHub#platformOrderReadyOrders) status in Orders Hub.


- `CLOSED`: The order is paid for and completed. This status corresponds to the [Completed](docs/en-us/adminGuide-platformUsingOrdersHub#platformCompletedOrders) status in Orders Hub. If a closed order is reopened, this moves the order back to the `IN_PREPARATION` status.
...
> **Note**
> 
> The Kitchen Display System (KDS) must be configured and enabled to automatically mark KDS-fulfilled orders as Order Ready in Orders Hub. For more information, see [Marking KDS-fulfilled orders as Order Ready](docs/en-us/adminGuide-platformUsingOrdersHub#platformMarkingKDSOrdersAsOrderReady).
