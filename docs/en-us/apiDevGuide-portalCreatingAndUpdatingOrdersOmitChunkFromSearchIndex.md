...
id: portalCreatingAndUpdatingOrdersOmitChunkFromSearchIndex
type: section
...
For other limitations on menu selection items, scheduling, and how orders from the API are processed, see [Orders API limitations](apiOrdersOmitChunkFromSearchIndex.html#ordersAPILimitations).
