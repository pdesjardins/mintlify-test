...
(1) Send a GET request to the
            /era/v1/guest/payments endpoint of the analytics
            API.

(2) Include the reportRequestGuid. For more
...
## Response to the retrieval request for guest reporting
        data
...
For more information about the values in the response, see
        [Understanding the guest reporting data](apiDevGuide-apiAnalyticsGuestDataUnderstandData).
