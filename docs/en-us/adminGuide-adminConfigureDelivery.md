...
- Disable delivery. Select this option to turn off delivery. You can also turn off delivery from the [online ordering dashboard](docs/en-us/adminGuide-adminOnlineOrderingDashboard).
