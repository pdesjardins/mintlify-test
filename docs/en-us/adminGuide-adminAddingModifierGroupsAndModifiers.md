...
7. Optionally, select the **Selected modifier groups** tab to review a list of the modifier groups you've chosen to add during this **Add existing**session. On the **Selected modifier groups** tab, you can:
...
You see the **Edit modifier**dialog:
