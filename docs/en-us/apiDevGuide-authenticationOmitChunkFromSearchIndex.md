...
id: authenticationOmitChunkFromSearchIndex
type: section
documentId: apiDevGuide
parentSectionFile: apiDevGuide-portalDevGettingStartedOmitChunkFromSearchIndex.md
...
| --- | --- |
| Partner integrations | Credentials are created by the Toast integrations team after your application has been reviewed and approved. For more information see, [Integration partnership process](integrationDevProcess.html). | 
| Custom integrations | Credentials are created by the Toast integrations team after you have been approved for custom integration access. For more information see, [Custom integration overview](ifYoureACustomIntegrationDeveloperOmitChunkFromSearchIndex.html#apiCustomIntegrationOverview). | 
| Standard API access | You create your own credentials through Toast Web. For more information, see [Creating standard API access credentials](devApiAccessCredentials.html#devApiAccessCreatingCredentials). | 
| Analytics API access | You create your own credentials through Toast Web. For more information, see [Creating analytics API access credentials](apiAnalyticsAccessCreatingCredentials.html). | 
...
The authentication API returns the information shown in the following example for a successful authentication request using a partner API client. For more information about partner API accounts, see [Toast API accounts](apiClientAccounts.html).

**Example 1.5. Authentication return data for a partner API client**

```
{
  "@class": ".SuccessfulResponse",[(1)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#mg_d1e276C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
  "token": {
    "tokenType": "Bearer",[(2)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#mg_d1e278C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
    "scope": null,[(3)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#mg_d1e280C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co) 
    "expiresIn": 19168,[(4)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#mg_d1e282C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
    "accessToken": "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJwYXJ0bmVyR3[(5)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#mg_d1e284C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
    ...
    "idToken": null,[(6)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#mg_d1e287C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
    "refreshToken": null[(7)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#mg_d1e289C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
  },
  "status": "SUCCESS"[(8)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#mg_d1e291C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
}
...
The authentication API returns the information shown in the following example for a successful authentication request using a restaurant management group API client. For more information about restaurant management group API accounts, see [Toast API accounts](apiClientAccounts.html).

**Example 1.7. Authentication return data for a restaurant management group client**

```
{
  "@class": ".SuccessfulResponse",[(1)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#d1e276C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
  "token": {
    "tokenType": "Bearer",[(2)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#d1e278C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
    "scope": null,[(3)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#d1e280C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co) 
    "expiresIn": 19168,[(4)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#d1e282C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
    "accessToken": "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJwYXJ0bmVyR3[(5)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#d1e284C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
      
      ...
      0hALk-LzyD-w_maz-s2kFx7vbWrp0l2X_gSpEi3JkZXJzOn81T-2bBtz4vkObQm27
      iI0Ww8K2ZeRwkSaR8zL2Qo-5NiIGRcml059S1_halz_GuWy4xOctS5WZOuIe5FaA",
    "idToken": null,[(6)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#d1e287C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
    "refreshToken": null[(7)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#d1e289C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
  },
  "status": "SUCCESS"[(8)](apiDevGuide-authenticationOmitChunkFromSearchIndex.html#d1e291C5E153BC-CA16-4F95-AF35-6E1AEA0AA25E-co)
}
