...
If your menu entities have names that begin with any of the following special characters, see [Special characters in items database export](platformItemsDatabaseExport.html#platformSpecialCharactersInItemsDatabaseExport) for additional important information:
