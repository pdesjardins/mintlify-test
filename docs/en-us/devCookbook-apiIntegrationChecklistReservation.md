...
- `labor:read` (this is optional. For more information, see [Determine what optional functionality you will support](apiIntegrationChecklistReservation.html#reservationIntegWriteOptional))


- `labor.employees:read` (this is optional. For more information, see [Determine what optional functionality you will support](apiIntegrationChecklistReservation.html#reservationIntegWriteOptional))
...
- `orders.orders:write` (for read-write integration only. For more information, see [Building a read-write reservation integration](apiIntegrationChecklistReservation.html#reservationIntegWrite))
...
- [Read-only reservation integration](apiIntegrationChecklistReservation.html#reservationIntegReadOnly): Manage reservations within your system without sharing details with the Toast platform.


- [Read-write reservation integration](apiIntegrationChecklistReservation.html#reservationIntegWrite): Your integration will pass reservation information to the Toast platform.
...
- Alternative payment types (this is optional. For more information, see [Determine what optional functionality you will support](apiIntegrationChecklistReservation.html#reservationIntegWriteOptional))
...
- Service charges (this is optional. For more information, see [Determine what optional functionality you will support](apiIntegrationChecklistReservation.html#reservationIntegWriteOptional))
...
- Collect the [reservation information](apiIntegrationChecklistReservation.html#reservationIntegWriteRequired) required by Toast for order submission.
...
3. Update the reservation in your system using the information outlined in [Understanding reservation order data](apiIntegrationChecklistReservation.html#reservationIntegData).
