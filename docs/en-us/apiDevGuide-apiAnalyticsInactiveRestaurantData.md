...
```
    ...
    <tr>
      <td>[(1)](#co-d1e2941F37ED50-563A-4DC2-A142-7FD5B7B554A5)</td>
      <td>Include the `onlyInactiveRestaurants` query parameter set to `TRUE` to request analytics data from inactive restaurants only.</td>
    </tr>
