...
Aggregated sales reporting data includes a high-level view of
      ...
      sales reporting data, see [Understanding aggregated sales reporting data](apiDevGuide-apiAnalyticsMetricsReportingDataUnderstandingData). For
      more information about inactive restaurant data, see [Viewing inactive restaurant data](apiDevGuide-apiAnalyticsInactiveRestaurantData).
...
1. Send a `POST` request to the
            ...
            information, see [Creating a request for aggregated sales reporting data](apiDevGuide-apiAnalyticsMetricsReportingDataCreateRequest).
...
2. Send a `GET` request to the
            ...
            information, see [Retrieving the aggregated sales reporting data](apiDevGuide-apiAnalyticsMetricsReportingDataRetrieveData).
...
> The `reportRequestGuid` expires seven days after you
        ...
        results in a 404 error. The `message` of the response body
