...
> **Important**
> 
> This section focuses on the configuration of each pricing strategy itself and assumes you have read the [Pricing menu items](docs/en-us/adminGuide-adminPricingMenuItems) and [Pricing modifiers](docs/en-us/adminGuide-adminPricingModifierOptions) sections and are familiar with the overall approach to pricing menu items and modifiers. For example, it assumes you know the difference between pricing menu items and modifiers at the group level versus pricing them individually. Also, it assumes you understand the structure of a modifier and that modifiers have an [underlying modifier item reference](docs/en-us/adminGuide-adminPricingModifierOptions#adminUnderstandingAModifierOptionsItemReference) that is effectively the same as a menu item.
