...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Sets the name of the discount. <br/>The name is used on the discount button on the Toast POS app (unless overridden by the POS Namesetting) and on sales reports.</td>
    </tr>
    <tr>
