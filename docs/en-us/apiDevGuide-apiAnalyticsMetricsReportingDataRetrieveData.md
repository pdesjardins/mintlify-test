...
Send a `GET`request to the `/era/v1/metrics/{reportRequestGuid}`endpoint to retrieve aggregated sales reporting data. The rate limit for this endpoint and method type is five requests per second and 30 requests per minute. For more information about API rate limits for the analytics API, see [Analytics API rate limits](apiAnalyticsOmitChunkFromSearchIndex.html#apiAnalyticsRateLimiting).
...
```
curl -X GET \ 'https://*`[toast-api-hostname]`*/era/v1/metrics/[(1)](apiDevGuide-apiAnalyticsMetricsReportingDataRetrieveData.html#d1e16496FAD0EEB-57EF-441A-9E58-614F985F6270-co)
fb23cfaa-56d7-4cb9-829d-531a8d02274a/' \[(2)](apiDevGuide-apiAnalyticsMetricsReportingDataRetrieveData.html#d1e16516FAD0EEB-57EF-441A-9E58-614F985F6270-co)
  -H 'Authorization: Bearer *`[token]`*'[(3)](apiDevGuide-apiAnalyticsMetricsReportingDataRetrieveData.html#d1e16556FAD0EEB-57EF-441A-9E58-614F985F6270-co)
...
For more information about the values in the response, see [Understanding aggregated sales reporting data](apiAnalyticsMetricsReportingDataUnderstandingData.html).
