...
The credit expiration limits the number of days that a guest can use the value of credits that you add in a single transaction. For more information see [Configuring credit expiration](adminConfiguringCustomerCreditExpiration.html).


5. Configure job permissions for your restaurant employees to allow them to look up guests and add credit value if needed. For more information, see [Configuring permissions for working with credits](adminConfigurePermissionsCustomerCredits.html).
