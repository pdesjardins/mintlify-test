...
> **Note**
> 
> The guest can add rewards to their order at any point
              before checkout.
...
> **Important**
> 
> Partners are responsible for confirming which offers are
            eligible for redemption, using the `applicable` boolean
            in the `Offer` object.
