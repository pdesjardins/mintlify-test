...
After an order is closed for a specific period of time, it is also marked as restricted. See [Working with restricted orders](adminViewingRestrictedOrders.html).
