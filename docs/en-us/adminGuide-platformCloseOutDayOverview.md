...
> **Note**
> 
> To use the **Close Out Day** screen, you must have **3. Manager &gt; 3.16 Close Out Day**permission.
...
1. On the Toast POS app, navigate to **Manager Activities**, and select **Close Out Day**to open the **Close Out Day** screen.
...
- **Create**: This opens the **Deposits** screen where you can create a deposit by selecting the **Add Deposit**button. If you create a deposit, the **Create deposit** step displays the number of deposits created.
