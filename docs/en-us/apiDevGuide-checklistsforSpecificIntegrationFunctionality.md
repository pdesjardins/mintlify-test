...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Retrieve employees from the labor API on a recurring basis.<br/>[More information](https://doc.toasttab.com/openapi/labor/operation/employeesGet/)</td>
    ...
    <tr>
      <td>Configuration Syncing</td>
      <td>Retrieve restaurant tables from the configuration API on a recurring basis.<br/>[More information](https://doc.toasttab.com/openapi/configuration/operation/tablesGet/)</td>
    ...
    <tr>
      <td>Configuration Syncing</td>
      <td>Retrieve restaurant hours from the restaurants API on a recurring basis.<br/>[More information](https://doc.toasttab.com/openapi/restaurants/operation/restaurantsRestaurantGuidGet/)</td>
    ...
    <tr>
      <td>Configuration Syncing</td>
      <td>Retrieve revenue centers from the configuration API on a recurring basis.<br/>[More information](https://doc.toasttab.com/openapi/configuration/operation/revenueCentersGet/)</td>
    ...
    <tr>
      <td>Configuration Syncing</td>
      <td>Retrieve dining options from the configuration API on a recurring basis.<br/>[More information](https://doc.toasttab.com/openapi/configuration/operation/diningOptionsGet/)</td>
    ...
    <tr>
      ...
      <td>Develop the capability to place a reservation order at the reserved table at the reservation time.<br/>Assign a revenue center and server to this order if appropriate.<br/>[More information](apiDevGuide-apiOrderTypeDetails#apiOrdersCreateDinein)</td>
    ...
    <tr>
      <td>Reporting</td>
      <td>Retrieve all configuration data that you will use in your reporting and analytics.<br/>Examples of configuration data that you may want include discounts, service charges, payment types, sales categories, menu items, and menu groups.<br/>[More information](https://doc.toasttab.com/openapi/configuration/overview/)</td>
    ...
    <tr>
      <td>Reporting</td>
      <td>Retrieve updates about orders associated with your reservations using using the `startDate`/`endDate` parameters of the `/orders` endpoint of the orders API.<br/>[More information](https://doc.toasttab.com/openapi/orders/operation/ordersGet/)</td>
