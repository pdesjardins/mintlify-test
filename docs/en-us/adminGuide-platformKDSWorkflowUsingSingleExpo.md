...
> **Note**
> 
> The tickets at each prep station use `ALSO AT` to indicate the name of the other prep station working on the order. For more information on this setting, see [Other Stations](adminKitchenDiningRoomReference.html#configOtherStations) of the Printed Tickets and Ticket Screens configuration section.
