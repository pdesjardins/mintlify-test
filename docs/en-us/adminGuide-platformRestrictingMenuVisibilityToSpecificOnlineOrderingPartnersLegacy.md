...
If your restaurant does not use the multi-location module, see [Ordering partner-specific settings for a single location](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformOrderingPartnerSpecificSettingsForASingleLocation)for information on using the ordering partner-specific settings. If your restaurant uses the multi-location module, see [Ordering partner-specific settings for multi-location restaurants](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformOrderingPartnerSpecificSettingsForMultiLocationRestaurants).
...
> **Note**
> 
> This section applies to restaurants that do not use the multi-location module. If your restaurant uses the multi-location module, see [Ordering partner-specific settings for multi-location restaurants](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformOrderingPartnerSpecificSettingsForMultiLocationRestaurants)instead.
...
7. If you are ready for guests and employees to see these menu changes, select Publish all changes, then select Publish again in the Confirm Publish dialog box. For more information, see [Understanding when to publish your menu](docs/en-us/adminGuide-adminUnderstandingWhenToPublishYourMenu).
...
> **Note**
> 
> This section applies to restaurants that use the multi-location module. If your restaurant does not use the multi-location module, see [Ordering partner-specific settings for a single location](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformOrderingPartnerSpecificSettingsForASingleLocation)instead.
...
> **Important**
> 
> If a menu is versioned, the ordering partner-specific visibility settings you set for one version apply to *all versions*. For more information, see [Ordering partner visibility settings and versioned menus](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformOrderingPartnerVisibilitySettingsAndVersionedMenus).


**Procedure 8.107. To configure ordering partner-specific visibility for a menu (multi-location)**
...
The dropdown lists only show locations that are included in the menu's target *and* that you have the [Restaurant Admin &gt; Edit Full Menu](docs/en-us/adminGuide-adminPermissions#adminRestaurantAdminAccessPermissions) permission to. For example, consider the following location group hierarchy:
...
> **Note**
> 
> If any of the menu versions has Online ordering partners set to Off, a warning appears. Setting them all so that Online ordering partners is On resolves the warning. For more information, see [Ordering partner visibility settings and versioned menus](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformOrderingPartnerVisibilitySettingsAndVersionedMenus).


**Procedure 8.108. To toggle Online ordering partners to On using the Advanced Properties page (multi-location)**
...
8. If the menu has multiple versions, select Online orders: Partners from the Visible tocolumn for each version. For more information, see [Ordering partner visibility settings and versioned menus](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformOrderingPartnerVisibilitySettingsAndVersionedMenus).
...
11. From the You are viewing menu, select the locations you want to view. For more information, see [Filtering pages](docs/en-us/adminGuide-filteringPagesForSpecificRestaurantGroupsAndLocations).
...
For more information on versions, see [Versions](docs/en-us/adminGuide-versions).
...
Before you can add a menu on the Third party ordering page, you must first enable its online ordering partner visibility, using one of the three procedures below. Single location restaurants can use any of the three procedures. Multi-location restaurants can use either the [second](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformToEnableOnlineOrderingPartnerVisibilityInTheClassicMenuDetailsPage)or [third](docs/en-us/adminGuide-platformRestrictingMenuVisibilityToSpecificOnlineOrderingPartnersLegacy#platformToEnableOnlineOrderingPartnerVisibilityOnTheAdvancedPropertiesPage)procedures.

**Procedure 8.109. To enable online ordering partner visibility in the menu manager**
...
**Procedure 8.110. To enable online ordering partner visibility in the classic menu details page**
...
**Procedure 8.111. To enable online ordering partner visibility on the Advanced Properties page**
...
For more information on the Third party ordering page, see [Adjusting menu visibility for a third-party online ordering channel](docs/en-us/adminGuide-platformThirdPartyOnlineOrderingMenuVisibility).
...
- Limited to menus. They are not available for menu groups, menu items, modifier groups, or [modifier item references](docs/en-us/adminGuide-adminPricingModifierOptions#adminUnderstandingAModifierOptionsItemReference).
...
> **Note**
> 
> See [Menu builder and the classic menu details pages](docs/en-us/adminGuide-adminBasicMenuBuilderAndTheLegacyMenuDetailsPages)for a comparison of the classic menu details pages and the menu manager.
