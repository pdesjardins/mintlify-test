...
**Procedure 8.128. To set fixed pricing on a modifier group**
...
> **Note**
> 
> The [Price Editor](docs/en-us/adminGuide-adminUsingThePriceEditor) does not yet support editing modifier group or modifier prices, so fixed prices for a modifier group must be edited on the modifier group's details page.
