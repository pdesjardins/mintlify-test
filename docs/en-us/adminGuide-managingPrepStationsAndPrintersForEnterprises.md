...
3. Use the You are viewing menu to show the prep stations for the corporate restaurant group (the corporate restaurant group is your top-level restaurant group and it should show all locations). See [Filtering pages](docs/en-us/adminGuide-filteringPagesForSpecificRestaurantGroupsAndLocations) for information on the You are viewing menu.
...
7. Continue with the [next procedure](docs/en-us/adminGuide-managingPrepStationsAndPrintersForEnterprises#toCreateMasterPrepStations) to create master prep stations.
...
2. Use the You are viewing menu to show the prep stations for the corporate restaurant group (this group will show all locations). See [Filtering pages](docs/en-us/adminGuide-filteringPagesForSpecificRestaurantGroupsAndLocations) for information on the You are viewing menu.
...
8. Continue with the [Procedure 5.15, “To create location-specific prep stations”](docs/en-us/adminGuide-managingPrepStationsAndPrintersForEnterprises#toCreateLocationSpecificPrepStations) procedure.
...
2. Use the You are viewing menu to show the prep stations for the corporate restaurant group (this group should show all locations). See [Filtering pages](docs/en-us/adminGuide-filteringPagesForSpecificRestaurantGroupsAndLocations) for information on the You are viewing menu.
...
9. Publish your changes using the Publish configpage. See [Publishing changes for multiple locations](docs/en-us/adminGuide-publishingChangesForMultipleLocations) for information on accessing and using that page.
