---
title: "Managing checks and orders"
id: adminOrderManagementOmitChunkFromSearchIndex
type: section
documentId: adminGuide
parentSectionFile: adminGuide-devPortalPlatformGuideOrdersOmitChunkFromSearchIndex.md
parentSectionTitle: "Chapter 2. Orders"
previousSectionFile: adminGuide-platformOrdersDetailsLinks.md
previousSectionTitle: "Displaying additional details about an order"
...
: [Access "mode" permissions](platformEmployeesOmitChunkFromSearchIndex.html#adminModePermissions)provide access to the areas of the Toast POS app where the check transfer options are located.
...
: The [Bulk Transfer Checks](platformEmployeesOmitChunkFromSearchIndex.html#permissionBulkTransferChecks) permission allows you to [select and transfer multiple checks](adminOrderManagementOmitChunkFromSearchIndex.html#platformOrdersTransferMultiple).
...
****Change Server****
: The [Change Server](platformEmployeesOmitChunkFromSearchIndex.html#permissionChangeServer)permission allows you to [select and transfer a single check or order](adminOrderManagementOmitChunkFromSearchIndex.html#platformOrdersTransferSingle).
