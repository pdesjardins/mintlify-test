...
> **Note**
> 
> To access the Review Employee Shifts screen, you must have 3. Manager &gt; 3.12 Shift Reviewpermission. For more information about permissions, see [Manager access permissions](docs/en-us/adminGuide-adminPermissions#adminManagerAccessPermissions).
...
> **Note**
> 
> To access the Time entries panel, you must have 3. Manager &gt; 3.14 Edit Time Entriespermission. For more information about permissions, see [Manager access permissions](docs/en-us/adminGuide-adminPermissions#adminManagerAccessPermissions).
...
- Declare or adjust cash tips. Select the Declare cash tips button to open a numerical keypad where you can enter a new numerical value or adjust your cash tips. The total declared cash tips appear below the Declare cash tips button. For more information, see [Declaring cash tips](docs/en-us/adminGuide-platformCompletingShiftReview#platformDeclaringCashTips).
