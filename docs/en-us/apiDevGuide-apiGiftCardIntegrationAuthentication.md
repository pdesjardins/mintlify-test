...
(3) The valuevalue includes the public key string. You can use the string supplied in the valuevalue to validate the authentication tokens in a Toast platform gift card transaction request.
