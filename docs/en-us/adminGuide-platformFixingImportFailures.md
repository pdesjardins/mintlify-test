...
**Procedure 8.150. To fix and re-import a bulk import .csv file**
...
6. Return to the bulk import tool and select **Retry import**. You see the **Upload template**page.


7. Select the **Upload file** button, locate and select the repaired CSV file, and select **Open**. Alternatively, you can drag and drop the repaired CSV file to the box with the dashed outline on the **Upload template**page.
