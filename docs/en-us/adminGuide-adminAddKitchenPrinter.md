...
- In a restaurant that primarily uses KDS devices, you add a kitchen printer to act as the backup when the system is in *offline mode*. For more information about KDS devices in offline mode, see [KDS devices](platformOfflineKDSDevices.html).
...
> **Note**
> 
> If this is the first printer added to your restaurant, move to [step 5](adminAddKitchenPrinter.html#AddPrinterOnPOSAppStep).
