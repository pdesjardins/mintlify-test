...
The reports in Toast Web include net sales values. You can also use [amount values from the orders API](docs/en-us/apiDevGuide-apiOrdersOrderObjectSummary#apiOrderObjectAmounts) to calculate the net sales.
...
2. [Calculate the net sales values for each order](docs/en-us/apiDevGuide-apiOrdersNetSalesCalculation#apiOrdersNetSalesSingleOrder).
