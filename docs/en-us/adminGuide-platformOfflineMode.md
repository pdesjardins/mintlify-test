...
- [Takeout and delivery orders](docs/en-us/adminGuide-adminOfflineDelivery)


- [Toast Online Ordering](docs/en-us/adminGuide-adminOfflineOnlineOrdering)


- [Employee clock-in and clock-out](docs/en-us/adminGuide-adminOfflineEmployees)


- [Offline card payments](docs/en-us/adminGuide-adminOfflineCCPayments)
...
To recover, first check that your local network cable is securely connected or Wi-Fi is enabled on the device. For more information, see [Local network disruption](docs/en-us/adminGuide-adminOfflineModeOverview#platformOfflineNetworkDisruptionType).
...
To resolve this issue, contact your internet service provider (ISP). For more information, see [Internet service provider disruption](docs/en-us/adminGuide-adminOfflineModeOverview#platformOfflineInternetDisruptionType).
...
- Set up a kitchen printer to print tickets that would normally display on a KDS device. For instructions, see [Adding a kitchen printer](docs/en-us/adminGuide-adminAddKitchenPrinter).
...
- Print kitchen tickets to backup printers (if configured). For more information, see the [Printing Mode](docs/en-us/adminGuide-adminKitchenDiningRoomReference#configPrintingMode) and [Always Print Tickets](docs/en-us/adminGuide-adminKitchenDiningRoomReference#configPrepStationsAlwaysPrintTickets) settings.



> **Note**
> 
> Kitchen workflows use *offline mode with local sync*, unless an error is detected by the KDS. For more information, see [KDS devices](docs/en-us/adminGuide-platformOfflineKDSDevices).
...
> **Note**
> 
> Kitchen workflows automatically use *offline mode with local sync*, unless an error is detected by the KDS. For more information, see [KDS devices](docs/en-us/adminGuide-platformOfflineKDSDevices).
