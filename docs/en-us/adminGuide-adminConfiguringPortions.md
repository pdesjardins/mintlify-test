...
- Enable the portions on each menu item that should be allowed to use them. For example, if you want your Pizza menu item to be able to use the **`1st Half`** and **`2nd
        Half`** portions, you must enable them on the Pizza menu item.
...
4. Enter a name for the portion, for example, **`1st
        Half`**.
