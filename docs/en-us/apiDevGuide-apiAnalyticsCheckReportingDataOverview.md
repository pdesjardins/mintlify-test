...
Check reporting data includes detailed check information for all
      ...
      included in the check reporting data, see [Understanding the check reporting data](apiDevGuide-apiAnalyticsCheckReportingDataUnderstandingData). For more
...
2. Send a `GET` request to
            ...
            [Retrieving the check reporting data](apiDevGuide-apiAnalyticsCheckReportingDataRetrieveData).
