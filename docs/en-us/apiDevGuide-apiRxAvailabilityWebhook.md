...
<table className="">
  ...
  <tbody className="">
    <tr className="">
      <td className="px-4 py-4"><div className="space-y-4"><p className="text-base leading-relaxed"><code className="font-mono text-sm">toggle_availability_online </code></p> <p className="text-base leading-relaxed">The online ordering channel toggle is on. </p></div></td>
      <td className="px-4 py-4"><div className="space-y-4"><p className="text-base leading-relaxed"><code className="font-mono text-sm">availability_online </code></p> <p className="text-base leading-relaxed">Restaurant health is online.</p></div></td>
      <td className="px-4 py-4"><div className="space-y-4"><p className="text-base leading-relaxed">The restaurant is online and available to accept online orders. </p></div></td>
    </tr>
    <tr className="">
      <td className="px-4 py-4"><div className="space-y-4"><p className="text-base leading-relaxed"><code className="font-mono text-sm">toggle_availability_online </code></p> <p className="text-base leading-relaxed">The online ordering channel toggle is on. </p></div></td>
