---
title: "Getting stock using the stock webhook"
id: apiUsingTheStockWebhook
type: section
...
excerpt: "To use the stock webhook, you must create a webhook endpoint...."
procedures: 0
codeExamples: 0
---
...
For detailed information on the updates provided by the stock webhook, including example payloads, see [Stock webhook](docs/en-us/apiDevGuide-apiStockWebhook).
