...
- My role. This option displays all orders from employees who are assigned the same job role as the check owner.
...
- Table orders. This option displays all orders assigned to a table.


- Online orders. This option displays all orders placed via Toast Online Ordering, the Local by Toast app, and third-party online ordering channels.




- Dining option. This list is dynamic and the filtering options available depend on your restaurant's configurations. For more information, see [Dining options](docs/en-us/adminGuide-index).
