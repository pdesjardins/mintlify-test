...
- Create a guest record using the Toast CRM (customer relations management) API. For more information, see [Working with guests (deprecated)](docs/en-us/apiDevGuide-apiDeprecatedApiFunctions#apiWorkingWithCustomers).
