...
[Menu availability](https://doc.toasttab.com/openapi/menusv3/tag/Data-definitions/schema/Availability/), [time-based prices](apiUsingPricingRulesAndPricingStrategyToCalculatePrices_V2.html#apiMenuItemWithATimeSpecificPrice_V2), and time-based discounts are all configured relative to a restaurant's local time.
