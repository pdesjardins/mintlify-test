...
[Menu
      ...
      prices](apiDevGuide-apiUsingPricingRulesAndPricingStrategyToCalculatePrices_V2#apiMenuItemWithATimeSpecificPrice_V2), and time-based discounts are all configured relative to
...
The `closeoutHour` JSON value and
      `schedules` object in the [restaurants API](apiDevGuide-apiRestaurantInformation) are both
