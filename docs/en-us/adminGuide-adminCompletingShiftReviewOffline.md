...
When the restaurant is back online, the manager can use the Time Entries report to [adjust the time entry](platformEmployeesOfflineModeOmitChunkFromSearchIndex.html#adminOfflineTimeEntries) for the employee.



> **Note**
> 
> Depending on the setting of the [Auto Clock-out](platformEmployeesOfflineModeOmitChunkFromSearchIndex.html#adminOfflineAutoClock) restaurant option, clocked-in employees may be automatically clocked out at the end of the business day.
