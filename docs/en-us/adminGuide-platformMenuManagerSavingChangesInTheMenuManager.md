...
Changes made in Full menu view must be manually published when you're ready for your employees and guests to see them. For more information, see [Saving changes and manually publishing them](platformPublishingMenuManagerChanges.html#platformSavingChangesAndManuallyPublishingThemMenuManager).
...
> **Important**
> 
> If you want to schedule your changes to be saved and published at a later date and time, do not use the Save [X] changes button. Use the Schedulebutton instead. For more information about scheduled publishing, see [Publishing menu manager changes](platformPublishingMenuManagerChanges.html).
