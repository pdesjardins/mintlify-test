...
> **Important**
> 
> If you want to schedule your changes to be saved and published at a later date and time, do not use the **Save [X] changes** button. Use the **Schedule**button instead. For more information about scheduled publishing, see [Publishing menu manager changes](adminGuide-platformPublishingMenuManagerChanges).
