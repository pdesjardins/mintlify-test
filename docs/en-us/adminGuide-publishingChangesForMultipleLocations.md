...
2. From the You are viewing menu, select the restaurants you want to view. For more details, see [Filtering pages](docs/en-us/adminGuide-filteringPagesForSpecificRestaurantGroupsAndLocations).
