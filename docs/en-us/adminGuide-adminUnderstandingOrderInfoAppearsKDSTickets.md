...
> **Note**
> 
> Whether the table or guest information appears before or after the check number depends on the [KDS Ticket Headers](docs/en-us/adminGuide-adminKitchenDiningRoomReference#configKdsTicketHeaders).
...
To prompt for a tab name on the Toast POS app, see [Prompt for tab name? (Quick Order only)](docs/en-us/adminGuide-adminUiOptionsReference#configPromptTabName).
