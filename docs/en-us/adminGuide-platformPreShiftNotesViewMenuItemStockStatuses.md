...
To change a menu item’s inventory status on Toast Web, see [Menu item inventory overview](docs/en-us/adminGuide-adminMenuItemInventoryOverview). You can change a menu item’s inventory from the [menu item’s details page](docs/en-us/adminGuide-adminInventoryUpdateBackend), or by entering the [Quick Edit mode](docs/en-us/adminGuide-adminInventoryUpdateQuickEdit) on any order screen on the Toast POS.
