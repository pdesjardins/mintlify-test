...
nextSectionFile: adminGuide-platformShiftsOverviewOmitChunkFromSearchIndex.md
nextSectionTitle: "Shifts"
...
> **Note**
> 
> If the **Pre-shift notes** screen is open on the POS device, you must close and reopen the screen to see the latest stock updates.
...
To change a menu item’s inventory status on Toast Web, see [Menu item inventory overview](adminGuide-adminMenuItemInventoryOverview). You can change a menu item’s inventory from the [menu item’s details page](adminGuide-adminInventoryUpdateBackend), or by entering the [Quick Edit mode](adminGuide-adminInventoryUpdateQuickEdit) on any order screen on the Toast POS.

## Displaying low and out of stock items

You can choose to automatically display a summary of low and out of stock menu items to your staff when they clock in on a Toast POS device.
...
2. Go to **Front of house &gt; Pre-shift notes**and toggle the **Menu item stock **setting to **On**.
...
4. Select the **Publish all changes** to publish your changes.
