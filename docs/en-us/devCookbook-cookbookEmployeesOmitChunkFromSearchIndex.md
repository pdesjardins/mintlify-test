---
title: "Employees"
id: cookbookEmployeesOmitChunkFromSearchIndex
type: section
...
previousSectionFile: devCookbook-devPortalCookbookHowToOmitChunkFromSearchIndex.md
previousSectionTitle: "Chapter 1. Recipes"
...
Consider loading [initial employee information](apiEmployeeInformationOmitChunkFromSearchIndex.html#api-get-all-employees)when a restaurant first connects to your platform. You can match employees based on identifying information such as names and email addresses. If you will use the `externalEmployeeId` field, you can also use this field to map employees in the Toast platform to employees in your system.
